...
! === FDE Phase B Step B1: minimal Poisson correction ===
    block
        real(dl) :: x_kl_b1, mu_b1, Sk_b3
        real(dl), parameter :: A_MU_B1    = 1.0_dl
        real(dl), parameter :: LAMBDA0_B1 = 0.3_dl
        real(dl), parameter :: KC_B3 = 0.20_dl
        real(dl), parameter :: N_B3  = 4.0_dl
